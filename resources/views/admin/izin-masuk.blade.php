...
@section('content')
<h2 class="text-xl font-bold mb-6">Data Izin Masuk</h2>
...
<div class="mb-4 flex gap-2">
    <a href="{{ route('admin.izin-masuk.export.excel', request()->query()) }}"
       class="bg-green-600 text-white px-4 py-2 rounded text-sm fa fa-file-excel-o"> Export Excel</a>

    <a href="{{ route('admin.izin-masuk.export.pdf', request()->query()) }}"
