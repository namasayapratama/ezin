...
<h4 class="text-center font-bold text-lg mb-4">Konfirmasi Kembali dari  Izin keluar</h4>            
            ...
            <table class="w-full">
                ...
                <tr><td><strong>Waktu Kembali</strong></td></td><td> : </td><td>{{ \Carbon\Carbon::parse($izin->waktu_kembali)->format('d/m/Y H:i') }}</td></tr>
            </table>
            <p>Pesan ini dikirim secara otomatis oleh sistem</p>
