...
<div class="flex flex-col items-center  px-4">
    ...
    <div x-data="{ showScanForm: false }" class="space-y-4 w-full max-w-md">
        ...
        <div x-show="showScanForm" x-transition>
            <form method="POST" action="{{ route('workstation.scan.submit') }}" x-ref="scanForm" class="w-full">
                @csrf
    ...
    <form id="scanForm" action="{{ route('workstation.scan.submit') }}" method="POST" class="hidden">
        @csrf
