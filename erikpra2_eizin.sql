...
(3, 'mail_host', 'smtp.gmail.com', NULL, NULL),
(4, 'mail_port', '587', NULL, NULL),
(5, 'mail_username', 'erikpratama@smkn4padalarang.sch.id', NULL, NULL),
(6, 'mail_password', 'bsjn jfqi rthe rweu', NULL, NULL),
(7, 'mail_encryption', 'tls', NULL, NULL),
(8, 'mail_from_address', 'noreply@smkn4padalarang.sch.id', NULL, NULL),
